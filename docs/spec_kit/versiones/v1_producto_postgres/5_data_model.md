...
PRIMERA vez (lo ejecuta `db\crear_bd.ps1` y corre
...
- El reset completo: `DROP DATABASE bdfacturas_postgres_local` (pgAdmin)
  y re-correr `.\db\crear_bd.ps1` (borra los datos y el
