...
Dos comandos dejan TODO el sistema de la versión
(`.\db\crear_bd.ps1` una sola vez, y `dotnet watch run`)
...
| Cosa | Convención |
|---|---|
| Puertos del proyecto | API facturas **8042** (fijado en launchSettings) · PostgreSQL **5432** (el servicio local de Windows) |
